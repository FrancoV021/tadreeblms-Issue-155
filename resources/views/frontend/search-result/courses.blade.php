                                                        ...
                                                        <div class="best-course-text">
                                                            ...
                                                            <div class="course-meta">
                                                                ...
                                                                <span class="course-author"><a href="#">{{ $course->students()->count() }}
                                                                        @lang('labels.frontend.search_result.students')</a>
                                                                </span>
                                                            </div>
                                                            ...
                                                            <form action="{{ route('cart.addToCart') }}" method="POST">
                                                                ...
                                                                <button class="genius-btn btn-block text-white  gradient-bg text-center text-uppercase  bold-font" href="#">
                                                                    @lang('labels.frontend.course.add_to_cart') 
                                                                    <i class="fas fa-caret-right"></i>
                                                                </button>
                                                            </form>
                                                            @else
                                                            <a class="genius-btn btn-block text-white  gradient-bg text-center text-uppercase  bold-font" href="{{ route('courses.show', [$course->slug]) }}">
