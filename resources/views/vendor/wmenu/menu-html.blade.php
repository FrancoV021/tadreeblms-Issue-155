                        ...
                        <div class="wrap">
                            <div class="manage-menus">
                                <form method="get" action="{{ $currentUrl }}">
                                    ...
                                    <span class="add-new-menu-action"> or <a href="{{ $currentUrl }}?action=edit&menu=0">{{ __('strings.backend.menu_manager.create_new') }}</a>. </span>
                                </form>
                            </div>
                                            ...
                                            <div id="side-sortables" class="accordion-container">
                                                <ul class="outer-border">
                                                    <li class="control-section accordion-section open add-page" id="add-page">
                                                        <h3 class="accordion-section-title hndle" tabindex="0">{{ __('strings.backend.menu_manager.custom_link') }} <span class="screen-reader-text">{{ __('strings.backend.menu_manager.screen_reader_text') }}</span></h3>
                                                        ...
                                                        <div class="d-inline-block w-100 action-wrapper border-top col-12 pt-2 pb-1">
                                                            <a href="#" onclick="addcustommenu()" class="btn btn-light add-to-menu border float-right submit-add-to-menu right">{{ __('strings.backend.menu_manager.add_to_menu') }}</a>
                                            ...
                                            <div class="accordion-container mt-4">
                                                <ul class="outer-border">
                                                    <li class="control-section accordion-section open">
                                                        <h3 class="accordion-section-title hndle" data-toggle="collapse" data-target="#pages" aria-expanded="true" aria-controls="pages" id="headingThree" tabindex="0">
                                                        ...
                                                        <div id="pages" class="collapse show" aria-labelledby="pages" data-parent="#accordion">
                                                            <div class="card-body px-3 pt-3 pb-0">
                                                                <div class="form-group">
                                                                    <input type="text" placeholder="Search Pages" class="form-control searchInput mb-3">
                                                                    <div class="checkbox-wrapper page">
                                                                        @if($pages->count() > 0)
                                                                            @foreach($pages as $item)
                                                                                <div class="checkbox" data-value="{{ $item->title }}">
                                                                                    <label>
                                                                                        <input type="checkbox" name="category[]" value="{{ $item->id }}"> &nbsp; {{ $item->title }}
                                                                                    </label>
                                                                                </div>
                                                                            @endforeach
                                                                        @endif
                                                            ...
                                                            <div class="d-inline-block w-100 action-wrapper border-top col-12 pt-2 pb-1">
                                                                <div class="checkbox float-left">
                                                                    <label class="my-2">
                                                                        <input type="checkbox" class="select_all"> &nbsp; {{ __('strings.backend.menu_manager.select_all') }}
                                                                    </label>
                                                                </div>
                                                    ...
                                                    <div class="major-publishing-actions">
                                                        ...
                                                        @if(request()->has('action'))
                                                            <div class="publishing-action">
                                                                <a onclick="createnewmenu()" name="save_menu" id="save_menu_header" class="btn btn-primary menu-save">{{ __('strings.backend.menu_manager.create_menu') }}</a>
                                                            </div>
                                                        @elseif(request()->has("menu"))
                                                            <div class="publishing-action">
                                                                <a onclick="getmenus()" name="save_menu" id="save_menu_header" class="btn btn-primary menu-save">{{ __('strings.backend.menu_manager.save_menu') }}</a>
                                                    ...
                                                    <div id="post-body-content">
                                                        @if(request()->has("menu"))
                                                            ...
                                                            <div class="drag-instructions post-body-plain">
                                                                <p>{{ __('strings.backend.menu_manager.drag_instruction_1') }}</p>
                                                            </div>
                                                        @else
                                                            <h3>{{ __('strings.backend.menu_manager.menu_creation') }}</h3>
                                                            <div class="drag-instructions post-body-plain">
                                                                <p>{{ __('strings.backend.menu_manager.drag_instruction_2') }}</p>
                                                            </div>
                                                        @endif
                                                            ...
                                                            @if(isset($menus))
                                                                @foreach($menus as $m)
                                                                    <li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
                                                                        <dl class="menu-item-bar">
                                                                            <dt class="menu-item-handle col-12 col-lg-7">
                                                                                <span class="item-title">
                                                                                    ...
                                                                                    <span class="is-submenu" style="@if($m->depth==0)display: none;@endif">{{ __('strings.backend.menu_manager.sub_menu') }}</span>
                                                                                </span>
                                                                        ...
                                                                        <div class="menu-item-settings col-12 col-lg-7" id="menu-item-settings-{{$m->id}}">
                                                                            <div class="row">
                                                                                <div class="col-12">
                                                                                    <input type="hidden" class="edit-menu-item-id" name="menuid_{{$m->id}}" value="{{$m->id}}"/>
                                                                                    <p class="description description-thin">
                                                                                        <label class="d-inline-block w-100" for="edit-menu-item-title-{{$m->id}}">
                                                                                            {{ __('strings.backend.menu_manager.label') }}<br>
                                                                                ...
                                                                                <p class="field-css-url description col-12 description-wide">
                                                                                    <label for="edit-menu-item-url-{{$m->id}}">
                                                                                        {{ __('strings.backend.menu_manager.url') }}<br>
                                                                                        <input type="text" id="url_menu_{{$m->id}}" class="widefat form-control edit-menu-item-url" value="{{$m->link}}">
                                                                                    </label>
                                                                                </p>
                                                                            </div>
                                                                            ...
                                                                            <p class="field-move hide-if-no-js description description-wide">
                                                                                <label>
                                                                                    <span>{{ __('strings.backend.menu_manager.move') }}:</span>
                                                                                    <a href="{{ $currentUrl }}" class="menus-move-up" style="display: none;">{{ __('strings.backend.menu_manager.move_up') }}</a>
                                                                                    <a href="{{ $currentUrl }}" class="menus-move-down" style="display: inline;">{{ __('strings.backend.menu_manager.move_down') }}</a>
                                                                                    ...
                                                                                    <a href="{{ $currentUrl }}" class="menus-move-top" style="display: none;">{{ __('strings.backend.menu_manager.top') }}</a>
                                                                                </label>
                                                                            </p>

                                                                            <div class="menu-item-actions description-wide submitbox text-right">
                                                                                <a class="item-delete submitdelete deletion btn btn-danger" id="delete-{{$m->id}}" href="{{ $currentUrl }}?action=delete-menu-item&menu-item={{$m->id}}&_wpnonce=2844002501">{{ __('strings.backend.menu_manager.delete') }}</a>
                                                                                <span class="meta-sep hide-if-no-js"> | </span>
                                                                                <a class="item-cancel btn btn-default submitcancel hide-if-no-js button-secondary" id="cancel-{{$m->id}}" href="{{ $currentUrl }}?edit-menu-item={{$m->id}}&cancel=1424297719#menu-item-settings-{{$m->id}}">{{ __('strings.backend.menu_manager.cancel') }}</a>
                                                                                <span class="meta-sep hide-if-no-js"> | </span>
                                                                                <a onclick="updateitem({{$m->id}})" class="btn btn-primary updatemenu" id="update-{{$m->id}}" href="javascript:void(0)">{{ __('strings.backend.menu_manager.update_item') }}</a>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div class="major-publishing-actions">
                                                        ...
                                                        @elseif(request()->has("menu"))
                                                            <span class="delete-action">
                                                                <a class="submitdelete deletion btn btn-danger menu-delete" onclick="deletemenu()" href="javascript:void(9)">{{ __('strings.backend.menu_manager.delete_menu') }}</a>
                                                            </span>
                                                            <div class="publishing-action">
                                                                <a onclick="getmenus()" name="save_menu" id="save_menu_header" class="btn btn-primary menu-save">{{ __('strings.backend.menu_manager.save_menu') }}</a>
                                                                <span class="spinner" id="spincustomu2"></span>
...
<script>
    ...
    $(document).on("input", ".searchInput", function () {
        ...
        for (i = 0; i < elements.length; i++) {
            ...
            elements[i].style.display = value.toUpperCase().indexOf(filter) > -1 ? "" : "none";
        }
    });
    ...
    $('.checkbox-wrapper .checkbox input').change(function () {
        ...
        if (!this.checked) selectCheckBox.checked = false;
        ...
        if (checked === totalCheckbox) selectCheckBox.checked = true;
    });
    ...
    $(document).on('click', '.add-to-menu', function () {
        ...
        if (checked.length > 0) {
            ...
            $.ajax({
                ...
                complete: function () { $("#spincustomu").hide(); }
            });
        }
    });
</script>
