...
<div class="row">
    <div class="col">
        ...
        <div class="form-group">
            {{ html()->label(__('Preferred Language'))->for('avatar') }}

            <div>
                <input type="radio" name="fav_lang"
                       value="english" {{ $user->fav_lang == 'english' ? 'checked' : '' }} /> {{__('English')}}
                &nbsp;&nbsp;
                <input type="radio" name="fav_lang"
                       value="arabic" {{ $user->fav_lang == 'arabic' ? 'checked' : '' }} /> {{__('Arabic')}}
            </div>
        </div><!--form-group-->
